<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMenu.Master" AutoEventWireup="true" CodeBehind="adminAddProduct.aspx.cs" Inherits="VS_FinalAssignment.adminAddProduct" %>
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-11 widget-right">
                                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary btn-md pull-right" OnClick="LinkButton1_Click" >Add</asp:LinkButton>
									</div>
								</div>
							</fieldset>
						</form>
