<%@ Page Title="" Language="C#" MasterPageFile="~/UserMenu.Master" AutoEventWireup="true" CodeBehind="UserRegister.aspx.cs" Inherits="VS_FinalAssignment.UserRegister" %>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 appointment_form">
              <div class="form_section">
                <form class="form_contant" action="index.html">
                  ...
                  <div class="center">
                    <asp:LinkButton ID="LinkButton1" class="btn main_bt" runat="server" OnClick="LinkButton1_Click" >Register</asp:LinkButton>
                  </div>
                  </fieldset>
                </form>
              </div>
